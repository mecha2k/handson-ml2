...
def runGaussianMixture():
    ...
    plt.savefig("./images/covariance_type_plot.png", format="png", dpi=300)
    plt.show()
    ...
    plt.ylim(top=5.1)
    plt.savefig("./images/mixture_anomaly_detection_plot.png", format="png", dpi=300)
    plt.show()
    ...
    for k in range(1, 11):
        for covariance_type in ("full", "tied", "spherical", "diag"):
            bic = (
                GaussianMixture(
                    n_components=k, n_init=10, covariance_type=covariance_type, random_state=42
                )
                .fit(X)
                .bic(X)
            )
...
def runVariationalBayesianGaussian():
    ...
    plt.savefig("./images/mixture_concentration_prior_plot.png", format="png", dpi=300)
    plt.show()
